...
public class ExampleFragmentsAdapter extends FragmentStatePagerAdapter {
    ...
    private int tabTitles[] = new int[] { R.string.fragment_title_default, R.string.fragment_title_default };
    private Fragment fragments[] = new Fragment[] { new DefaultFragment(), new DefaultFragment() };
